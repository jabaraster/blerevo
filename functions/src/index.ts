...
export const firebase = !fb.apps.length ? fb.initializeApp({
...
// export const personalizedNotification = functions.region("asia-northeast1")
//     .https.onCall((data: any, _: any) => {
//     return data
// })

exports.notification = functions.region("asia-northeast1").pubsub.schedule("every 1 minutes").onRun(async context => {
...
function getNotificatedCollection(server: string): CollectionReference<DocumentData> {
